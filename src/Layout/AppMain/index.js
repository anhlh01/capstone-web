...
const ApplicationDetail = lazy(() => import("../../DemoPages/Applications/Detail/"));
const UserDetailCover = lazy(() => import("../../DemoPages/Users/user-detail-cover"));
    ...
    return (
        <Fragment>
            ...
            <Suspense fallback={
                ...
                <Route path="/applications/details" component={ApplicationDetail} />
            </Suspense>
            ...
            <Suspense fallback={
                ...
                <Route path="/user/:id" exact component={UserDetailCover} />
            </Suspense>
